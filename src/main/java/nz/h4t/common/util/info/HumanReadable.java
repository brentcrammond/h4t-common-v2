...
/**
 * The HumanReadable interface provides utility methods for converting byte counts
 * into human-readable string representations. This is useful for formatting file
...
public interface HumanReadable {
     ...
     *
     * @param bytes the number of bytes to convert; can be negative to indicate
